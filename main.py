...
def main() :
    st.set_page_config("AI Image Classifier", page_icon="🤖", layout="centered")

    st.title("AI Image Classifer")
    st.write("Upload the image and let the AI tell what it is!")
    ...
    uploaded_file = st.file_uploader("Choose and image...", type=["jpg", "png"])
